                    ...
                    <div className="mt-auto">
                        {product.id === "law-connect" ? (
                            <div className="flex flex-col gap-3">
                                <a href="https://app.vakaalat.in" target="_blank" rel="noopener noreferrer">
                                   <Button variant="accent" className="w-full">
                                       Web App
                                   </Button>
                                </a>
                                <a href="https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/build_outputs/vakaalat-app-x6krpe/web/KGpGflQw4JmhfWXVUu0L/Vakaalat%20One-release.apk" target="_blank" rel="noopener noreferrer">
